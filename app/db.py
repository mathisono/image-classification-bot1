...
CREATE TABLE IF NOT EXISTS images (
    ...
    short_caption TEXT, detailed_description TEXT, scene_type TEXT, orientation TEXT,
    image_type TEXT, category TEXT, tags TEXT, objects TEXT, visible_text TEXT,
    people_detected INTEGER CHECK(people_detected IN (0,1) OR people_detected IS NULL),
    people_count INTEGER, notes TEXT, model_used TEXT, prompt_version TEXT,
    ...
    face_detected INTEGER CHECK(face_detected IN (0,1) OR face_detected IS NULL),
...
MIGRATIONS = {
    ...
    'scene_type': 'ALTER TABLE images ADD COLUMN scene_type TEXT',
    'orientation': 'ALTER TABLE images ADD COLUMN orientation TEXT',
    'people_detected': 'ALTER TABLE images ADD COLUMN people_detected INTEGER',
    'people_count': 'ALTER TABLE images ADD COLUMN people_count INTEGER',
    'has_face': 'ALTER TABLE images ADD COLUMN has_face INTEGER',
    'face_detected': 'ALTER TABLE images ADD COLUMN face_detected INTEGER',
